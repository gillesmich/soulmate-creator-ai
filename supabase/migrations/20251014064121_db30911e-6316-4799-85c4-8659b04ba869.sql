...
-- Grant admin role to gillesmich@yahoo.fr
DO $$
DECLARE
  admin_user_id uuid;
BEGIN
  ...
  IF admin_user_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'Admin role granted to gillesmich@yahoo.fr';
  ELSE
    RAISE NOTICE 'User gillesmich@yahoo.fr not found yet - admin role will need to be assigned manually after signup';
  END IF;
END $$;